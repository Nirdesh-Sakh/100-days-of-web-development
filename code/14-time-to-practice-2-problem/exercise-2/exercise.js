...
const secondButton=document.getElementById("bg-color");
...
secondButton.addEventListener("click",addBlueBg);
...
function addBlueBg(event){
    //Using css class to modify css through javascript
    firstParagraph.classList.add("blue-color"); 
